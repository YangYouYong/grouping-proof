 ...
 * 
 * $Id: mifare_ultralight.c 778 2011-04-05 21:05:27Z rtartiere@il4p.fr $
 */
...
int
mifare_ultralightc_authenticate_test (const MifareDESFireKey key)
{
    BUFFER_INIT (res, 9);
/*    res[1] = 0x00;//6b37c87d64f417a8    6b37c87d64f47fa8
 	res[2] = 0x00;
	res[3] = 0x00;
	res[4] = 0x00;
	res[5] = 0x00;
    ...
    res[1] = 0x6b;//6b37c87d64f417a8    6b37c87d64f47fa8
 	res[2] = 0x37;
	res[3] = 0xc8;
	res[4] = 0x7d;
	res[5] = 0x64;
    ...
    warnx (base64(PICC_RndB, sizeof(PICC_RndB)));
    uint8_t PCD_RndA[8];
	PCD_RndA[0] = 0x00;
	PCD_RndA[1] = 0x00;
	PCD_RndA[2] = 0x00;
    ...
    rol (PCD_r_RndB, 8);
    warnx (base64(PCD_r_RndB, sizeof(PCD_r_RndB)));
    uint8_t token[16];
    ...
    warnx (base64(token, sizeof(token)));
//    warnx ("H");
